...
const Footer = () => {
  return (
    <footer className="flex w-full max-w-[90rem] flex-col bg-black px-[3.25rem] py-14 text-[0.9375rem] leading-[1.5625rem] text-white md:flex-row md:items-center md:justify-between md:pb-8 md:pt-[2.75rem] lg:pl-[10.31rem] lg:pr-[9.25rem]">
